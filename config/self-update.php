...
return [
 ...
 /*
    ...
    |--------------------------------------------------------------------------
    */
    'app_name' => parse_ini_file(dirname(__DIR__,1).DIRECTORY_SEPARATOR.'storage'.DIRECTORY_SEPARATOR.'faveoconfig.ini', false, INI_SCANNER_RAW)['PRODUCT_NAME_FOR_AUTO_UPDATE'],
