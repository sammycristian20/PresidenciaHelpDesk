...
return [
    ...
    'version' => parse_ini_file(dirname(__DIR__,1).DIRECTORY_SEPARATOR.'storage'.DIRECTORY_SEPARATOR.'faveoconfig.ini', false, INI_SCANNER_RAW)['APP_NAME']." ".parse_ini_file(dirname(__DIR__,1).DIRECTORY_SEPARATOR.'storage'.DIRECTORY_SEPARATOR.'faveoconfig.ini', false, INI_SCANNER_RAW)['APP_VERSION'],



    'tags'    => parse_ini_file(dirname(__DIR__,1).DIRECTORY_SEPARATOR.'storage'.DIRECTORY_SEPARATOR.'faveoconfig.ini', false, INI_SCANNER_RAW)['APP_VERSION'],
    ...
    'providers' => [
        ...
        App\FileManager\FileManagerServiceProvider::class,
