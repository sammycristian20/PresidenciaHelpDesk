...
use App\FileManager\Services\ACLService\FileManagerDepartmentAccessControl;
...
return [
     ...
     */
    'aclRepository' => FileManagerDepartmentAccessControl::class,
     ...
     */
    'diskList' => ['system','s3','public','private'],
     ...
     */
    'maxUploadFileSize' => ((int) ini_get('post_max_size')) * 1024,
     ...
     * [] - no restrictions
     */
    'allowFileTypes' => ['png', 'gif', 'jpg', 'jpeg', 'zip', 'rar', 'doc', 'docx', 'xls', 'xlsx', 'ppt', 'pptx', 'pdf', 'csv','txt'],
