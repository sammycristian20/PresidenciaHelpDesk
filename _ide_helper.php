 ...
 * Generated for Laravel 5.4.30 on 2017-08-16.
 *
...
namespace Illuminate\Support\Facades { 
    ...
    class Artisan {
         ...
         * @static 
         */ 
        public static function execute($schedule, $task)
        {
            return \App\Console\Kernel::execute($schedule, $task);
        }
         ...
         * @static 
         */ 
        public static function getCondition($schedule, $command)
        {
            return \App\Console\Kernel::getCondition($schedule, $command);
        }
         ...
         * @static 
         */ 
        public static function getConditionWithOption($schedule, $command, $at)
        {
            return \App\Console\Kernel::getConditionWithOption($schedule, $command, $at);
        }
        ...
        {
            return \App\Console\Kernel::getCurrentQueue();
        }
...
namespace Vsmoraes\Pdf { 
    ...
    class PdfFacade {
        ...
        {
            return \Vsmoraes\Pdf\Dompdf::load($html, $size, $orientation);
        }
        ...
        {
            return \Vsmoraes\Pdf\Dompdf::filename($filename);
        }
         ...
         * @static 
         */ 
        public static function setPaper($size, $orientation)
        {
            return \Vsmoraes\Pdf\Dompdf::setPaper($size, $orientation);
        }
        ...
        {
            return \Vsmoraes\Pdf\Dompdf::render();
        }
        ...
        {
            return \Vsmoraes\Pdf\Dompdf::clear();
        }
        ...
        {
            return \Vsmoraes\Pdf\Dompdf::show($options);
        }
         ...
         * @static 
         */ 
        public static function download($options = array())
        {
            return \Vsmoraes\Pdf\Dompdf::download($options);
        }
        ...
        {
            return \Vsmoraes\Pdf\Dompdf::output($options);
        }
...
namespace Thomaswelton\LaravelGravatar\Facades { 
    ...
    class Gravatar {
        ...
        {
            return \Thomaswelton\LaravelGravatar\Gravatar::src($email, $size, $rating);
        }
        ...
        {
            return \Thomaswelton\LaravelGravatar\Gravatar::image($email, $alt, $attributes, $rating);
        }
...
namespace  { 
    ...
    class PDF extends \Vsmoraes\Pdf\PdfFacade {}

    class Gravatar extends \Thomaswelton\LaravelGravatar\Facades\Gravatar {}

    class UTC extends \App\Http\Controllers\Agent\helpdesk\TicketController {}

    class Ttable extends \App\Http\Controllers\Agent\helpdesk\TicketController {}

    class SMTPS extends \App\Http\Controllers\HomeController {}
    ...
    class UnAuth extends \App\Http\Controllers\Client\helpdesk\UnAuthController {}

    class Finder extends \App\Helper\Finder {}
