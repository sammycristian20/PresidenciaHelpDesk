...
function setAplInfo()
{
	$salt = parse_ini_file(dirname(__DIR__,2).DIRECTORY_SEPARATOR.'storage'.DIRECTORY_SEPARATOR.'faveoconfig.ini', false, INI_SCANNER_RAW);
	...
	// define("APL_SALT", 'b047c04cde662b7a');
