...
function fetch_select(val)
{
   $.ajax({
    ...
    public function department($conversation) {
        ...
        if ($ticket->rc_ticketid == '0') {
            ...
            return "<div class='col-md-2'>" .
                    ...
                    . "</div>
                    <div class='col-md-10'>"
                    . Form::select('department', ['' => 'Choose one Department', 'Departments' => $departments->pluck('rcdpt_name', 'middledpt_id')], null, ['id' => 'email', 'class' => 'form-control', 'style' => 'width:55%', 'onchange' => 'fetch_select(this.value)']) . "
                   </div>";
        }
    }
    ...
    public function TestView() {
        return view('reseller::department');
    }
    ...
    public function TicketDetails($thread) {
        //dd($threadid);
        $ticket = new Tickets();
        $thread = new Ticket_Thread;
