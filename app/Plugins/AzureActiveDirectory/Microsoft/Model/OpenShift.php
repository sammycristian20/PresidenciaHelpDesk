    ...
    */
    public function getSharedOpenShift()
    {
        if (array_key_exists("sharedOpenShift", $this->_propDict)) {
            if (is_a($this->_propDict["sharedOpenShift"], "App\Plugins\AzureActiveDirectory\Microsoft\Model\OpenShiftItem")) {
    ...
    */
    public function getDraftOpenShift()
    {
        if (array_key_exists("draftOpenShift", $this->_propDict)) {
            if (is_a($this->_propDict["draftOpenShift"], "App\Plugins\AzureActiveDirectory\Microsoft\Model\OpenShiftItem")) {
