    ...
    */
    public function getApplicationEnforcedRestrictions()
    {
        if (array_key_exists("applicationEnforcedRestrictions", $this->_propDict)) {
            if (is_a($this->_propDict["applicationEnforcedRestrictions"], "App\Plugins\AzureActiveDirectory\Microsoft\Model\ApplicationEnforcedRestrictionsSessionControl")) {
    ...
    */
    public function getCloudAppSecurity()
    {
        if (array_key_exists("cloudAppSecurity", $this->_propDict)) {
            if (is_a($this->_propDict["cloudAppSecurity"], "App\Plugins\AzureActiveDirectory\Microsoft\Model\CloudAppSecuritySessionControl")) {
    ...
    */
    public function getSignInFrequency()
    {
        if (array_key_exists("signInFrequency", $this->_propDict)) {
            if (is_a($this->_propDict["signInFrequency"], "App\Plugins\AzureActiveDirectory\Microsoft\Model\SignInFrequencySessionControl")) {
    ...
    */
    public function getPersistentBrowser()
    {
        if (array_key_exists("persistentBrowser", $this->_propDict)) {
            if (is_a($this->_propDict["persistentBrowser"], "App\Plugins\AzureActiveDirectory\Microsoft\Model\PersistentBrowserSessionControl")) {
