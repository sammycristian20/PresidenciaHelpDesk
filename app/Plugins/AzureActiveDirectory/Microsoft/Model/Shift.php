    ...
    */
    public function getSharedShift()
    {
        if (array_key_exists("sharedShift", $this->_propDict)) {
            if (is_a($this->_propDict["sharedShift"], "App\Plugins\AzureActiveDirectory\Microsoft\Model\ShiftItem")) {
    ...
    */
    public function getDraftShift()
    {
        if (array_key_exists("draftShift", $this->_propDict)) {
            if (is_a($this->_propDict["draftShift"], "App\Plugins\AzureActiveDirectory\Microsoft\Model\ShiftItem")) {
