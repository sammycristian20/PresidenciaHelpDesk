    ...
    */
    public function getMediaType()
    {
        if (array_key_exists("mediaType", $this->_propDict)) {
            if (is_a($this->_propDict["mediaType"], "App\Plugins\AzureActiveDirectory\Microsoft\Model\Modality")) {
    ...
    */
    public function getDirection()
    {
        if (array_key_exists("direction", $this->_propDict)) {
            if (is_a($this->_propDict["direction"], "App\Plugins\AzureActiveDirectory\Microsoft\Model\MediaDirection")) {
