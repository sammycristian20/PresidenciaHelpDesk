    ...
    */
    public function getRoutingType()
    {
        if (array_key_exists("routingType", $this->_propDict)) {
            if (is_a($this->_propDict["routingType"], "App\Plugins\AzureActiveDirectory\Microsoft\Model\RoutingType")) {
    ...
    */
    public function getOriginal()
    {
        if (array_key_exists("original", $this->_propDict)) {
            if (is_a($this->_propDict["original"], "App\Plugins\AzureActiveDirectory\Microsoft\Model\IdentitySet")) {
    ...
    */
    public function getFinal()
    {
        if (array_key_exists("final", $this->_propDict)) {
            if (is_a($this->_propDict["final"], "App\Plugins\AzureActiveDirectory\Microsoft\Model\IdentitySet")) {
