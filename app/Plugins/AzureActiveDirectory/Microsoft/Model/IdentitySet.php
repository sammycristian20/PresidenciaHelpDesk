    ...
    */
    public function getApplication()
    {
        if (array_key_exists("application", $this->_propDict)) {
            if (is_a($this->_propDict["application"], "App\Plugins\AzureActiveDirectory\Microsoft\Model\Identity")) {
    ...
    */
    public function getDevice()
    {
        if (array_key_exists("device", $this->_propDict)) {
            if (is_a($this->_propDict["device"], "App\Plugins\AzureActiveDirectory\Microsoft\Model\Identity")) {
    ...
    */
    public function getUser()
    {
        if (array_key_exists("user", $this->_propDict)) {
            if (is_a($this->_propDict["user"], "App\Plugins\AzureActiveDirectory\Microsoft\Model\Identity")) {
