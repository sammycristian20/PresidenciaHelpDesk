    ...
    */
    public function getActivityDomain()
    {
        if (array_key_exists("activityDomain", $this->_propDict)) {
            if (is_a($this->_propDict["activityDomain"], "App\Plugins\AzureActiveDirectory\Microsoft\Model\ActivityDomain")) {
    ...
    */
    public function getTimeSlots()
    {
        if (array_key_exists("timeSlots", $this->_propDict)) {
            if (is_a($this->_propDict["timeSlots"], "App\Plugins\AzureActiveDirectory\Microsoft\Model\TimeSlot")) {
