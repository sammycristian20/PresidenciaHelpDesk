    ...
    */
    public function getLarge()
    {
        if (array_key_exists("large", $this->_propDict)) {
            if (is_a($this->_propDict["large"], "App\Plugins\AzureActiveDirectory\Microsoft\Model\Thumbnail")) {
    ...
    */
    public function getMedium()
    {
        if (array_key_exists("medium", $this->_propDict)) {
            if (is_a($this->_propDict["medium"], "App\Plugins\AzureActiveDirectory\Microsoft\Model\Thumbnail")) {
    ...
    */
    public function getSmall()
    {
        if (array_key_exists("small", $this->_propDict)) {
            if (is_a($this->_propDict["small"], "App\Plugins\AzureActiveDirectory\Microsoft\Model\Thumbnail")) {
    ...
    */
    public function getSource()
    {
        if (array_key_exists("source", $this->_propDict)) {
            if (is_a($this->_propDict["source"], "App\Plugins\AzureActiveDirectory\Microsoft\Model\Thumbnail")) {
