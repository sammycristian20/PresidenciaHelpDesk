    ...
    */
    public function getParticipants()
    {
        if (array_key_exists("participants", $this->_propDict)) {
            if (is_a($this->_propDict["participants"], "App\Plugins\AzureActiveDirectory\Microsoft\Model\MeetingParticipants")) {
    ...
    */
    public function getAudioConferencing()
    {
        if (array_key_exists("audioConferencing", $this->_propDict)) {
            if (is_a($this->_propDict["audioConferencing"], "App\Plugins\AzureActiveDirectory\Microsoft\Model\AudioConferencing")) {
    ...
    */
    public function getJoinInformation()
    {
        if (array_key_exists("joinInformation", $this->_propDict)) {
            if (is_a($this->_propDict["joinInformation"], "App\Plugins\AzureActiveDirectory\Microsoft\Model\ItemBody")) {
