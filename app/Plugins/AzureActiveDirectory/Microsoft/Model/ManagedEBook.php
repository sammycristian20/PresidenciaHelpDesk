    ...
    */
    public function getLargeCover()
    {
        if (array_key_exists("largeCover", $this->_propDict)) {
            if (is_a($this->_propDict["largeCover"], "App\Plugins\AzureActiveDirectory\Microsoft\Model\MimeContent")) {
    ...
    */
    public function getInstallSummary()
    {
        if (array_key_exists("installSummary", $this->_propDict)) {
            if (is_a($this->_propDict["installSummary"], "App\Plugins\AzureActiveDirectory\Microsoft\Model\EBookInstallSummary")) {
