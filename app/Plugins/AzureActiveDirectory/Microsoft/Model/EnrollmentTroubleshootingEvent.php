    ...
    */
    public function getEnrollmentType()
    {
        if (array_key_exists("enrollmentType", $this->_propDict)) {
            if (is_a($this->_propDict["enrollmentType"], "App\Plugins\AzureActiveDirectory\Microsoft\Model\DeviceEnrollmentType")) {
    ...
    */
    public function getFailureCategory()
    {
        if (array_key_exists("failureCategory", $this->_propDict)) {
            if (is_a($this->_propDict["failureCategory"], "App\Plugins\AzureActiveDirectory\Microsoft\Model\DeviceEnrollmentFailureReason")) {
