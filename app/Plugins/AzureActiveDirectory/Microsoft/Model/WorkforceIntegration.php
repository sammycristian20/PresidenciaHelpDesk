    ...
    */
    public function getEncryption()
    {
        if (array_key_exists("encryption", $this->_propDict)) {
            if (is_a($this->_propDict["encryption"], "App\Plugins\AzureActiveDirectory\Microsoft\Model\WorkforceIntegrationEncryption")) {
    ...
    */
    public function getSupportedEntities()
    {
        if (array_key_exists("supportedEntities", $this->_propDict)) {
            if (is_a($this->_propDict["supportedEntities"], "App\Plugins\AzureActiveDirectory\Microsoft\Model\WorkforceIntegrationSupportedEntities")) {
