    ...
    */
    public function getScheduleItems()
    {
        if (array_key_exists("scheduleItems", $this->_propDict)) {
            if (is_a($this->_propDict["scheduleItems"], "App\Plugins\AzureActiveDirectory\Microsoft\Model\ScheduleItem")) {
    ...
    */
    public function getError()
    {
        if (array_key_exists("error", $this->_propDict)) {
            if (is_a($this->_propDict["error"], "App\Plugins\AzureActiveDirectory\Microsoft\Model\FreeBusyError")) {
