    ...
    */
    public function getUser()
    {
        if (array_key_exists("user", $this->_propDict)) {
            if (is_a($this->_propDict["user"], "App\Plugins\AzureActiveDirectory\Microsoft\Model\UserIdentity")) {
    ...
    */
    public function getApp()
    {
        if (array_key_exists("app", $this->_propDict)) {
            if (is_a($this->_propDict["app"], "App\Plugins\AzureActiveDirectory\Microsoft\Model\AppIdentity")) {
