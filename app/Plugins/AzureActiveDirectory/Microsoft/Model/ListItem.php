    ...
    */
    public function getContentType()
    {
        if (array_key_exists("contentType", $this->_propDict)) {
            if (is_a($this->_propDict["contentType"], "App\Plugins\AzureActiveDirectory\Microsoft\Model\ContentTypeInfo")) {
    ...
    */
    public function getFields()
    {
        if (array_key_exists("fields", $this->_propDict)) {
            if (is_a($this->_propDict["fields"], "App\Plugins\AzureActiveDirectory\Microsoft\Model\FieldValueSet")) {
