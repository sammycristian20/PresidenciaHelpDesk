    ...
    */
    public function getResult()
    {
        if (array_key_exists("result", $this->_propDict)) {
            if (is_a($this->_propDict["result"], "App\Plugins\AzureActiveDirectory\Microsoft\Model\OperationResult")) {
    ...
    */
    public function getInitiatedBy()
    {
        if (array_key_exists("initiatedBy", $this->_propDict)) {
            if (is_a($this->_propDict["initiatedBy"], "App\Plugins\AzureActiveDirectory\Microsoft\Model\AuditActivityInitiator")) {
