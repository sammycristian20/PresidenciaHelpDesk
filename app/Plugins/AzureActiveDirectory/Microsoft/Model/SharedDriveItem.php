    ...
    */
    public function getOwner()
    {
        if (array_key_exists("owner", $this->_propDict)) {
            if (is_a($this->_propDict["owner"], "App\Plugins\AzureActiveDirectory\Microsoft\Model\IdentitySet")) {
    ...
    */
    public function getDriveItem()
    {
        if (array_key_exists("driveItem", $this->_propDict)) {
            if (is_a($this->_propDict["driveItem"], "App\Plugins\AzureActiveDirectory\Microsoft\Model\DriveItem")) {
    ...
    */
    public function getList()
    {
        if (array_key_exists("list", $this->_propDict)) {
            if (is_a($this->_propDict["list"], "App\Plugins\AzureActiveDirectory\Microsoft\Model\List")) {
    ...
    */
    public function getPermission()
    {
        if (array_key_exists("permission", $this->_propDict)) {
            if (is_a($this->_propDict["permission"], "App\Plugins\AzureActiveDirectory\Microsoft\Model\Permission")) {
    ...
    */
    public function getRoot()
    {
        if (array_key_exists("root", $this->_propDict)) {
            if (is_a($this->_propDict["root"], "App\Plugins\AzureActiveDirectory\Microsoft\Model\DriveItem")) {
    ...
    */
    public function getSite()
    {
        if (array_key_exists("site", $this->_propDict)) {
            if (is_a($this->_propDict["site"], "App\Plugins\AzureActiveDirectory\Microsoft\Model\Site")) {
