    ...
    */
    public function getMessageActionFlag()
    {
        if (array_key_exists("messageActionFlag", $this->_propDict)) {
            if (is_a($this->_propDict["messageActionFlag"], "App\Plugins\AzureActiveDirectory\Microsoft\Model\MessageActionFlag")) {
    ...
    */
    public function getFromAddresses()
    {
        if (array_key_exists("fromAddresses", $this->_propDict)) {
            if (is_a($this->_propDict["fromAddresses"], "App\Plugins\AzureActiveDirectory\Microsoft\Model\Recipient")) {
    ...
    */
    public function getSentToAddresses()
    {
        if (array_key_exists("sentToAddresses", $this->_propDict)) {
            if (is_a($this->_propDict["sentToAddresses"], "App\Plugins\AzureActiveDirectory\Microsoft\Model\Recipient")) {
    ...
    */
    public function getWithinSizeRange()
    {
        if (array_key_exists("withinSizeRange", $this->_propDict)) {
            if (is_a($this->_propDict["withinSizeRange"], "App\Plugins\AzureActiveDirectory\Microsoft\Model\SizeRange")) {
