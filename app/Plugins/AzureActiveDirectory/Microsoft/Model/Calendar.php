    ...
    */
    public function getColor()
    {
        if (array_key_exists("color", $this->_propDict)) {
            if (is_a($this->_propDict["color"], "App\Plugins\AzureActiveDirectory\Microsoft\Model\CalendarColor")) {
    ...
    */
    public function getOwner()
    {
        if (array_key_exists("owner", $this->_propDict)) {
            if (is_a($this->_propDict["owner"], "App\Plugins\AzureActiveDirectory\Microsoft\Model\EmailAddress")) {
    ...
    */
    public function getDefaultOnlineMeetingProvider()
    {
        if (array_key_exists("defaultOnlineMeetingProvider", $this->_propDict)) {
            if (is_a($this->_propDict["defaultOnlineMeetingProvider"], "App\Plugins\AzureActiveDirectory\Microsoft\Model\OnlineMeetingProviderType")) {
