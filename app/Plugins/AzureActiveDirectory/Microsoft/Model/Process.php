    ...
    */
    public function getFileHash()
    {
        if (array_key_exists("fileHash", $this->_propDict)) {
            if (is_a($this->_propDict["fileHash"], "App\Plugins\AzureActiveDirectory\Microsoft\Model\FileHash")) {
    ...
    */
    public function getIntegrityLevel()
    {
        if (array_key_exists("integrityLevel", $this->_propDict)) {
            if (is_a($this->_propDict["integrityLevel"], "App\Plugins\AzureActiveDirectory\Microsoft\Model\ProcessIntegrityLevel")) {
