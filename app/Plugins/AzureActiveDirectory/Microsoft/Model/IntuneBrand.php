    ...
    */
    public function getThemeColor()
    {
        if (array_key_exists("themeColor", $this->_propDict)) {
            if (is_a($this->_propDict["themeColor"], "App\Plugins\AzureActiveDirectory\Microsoft\Model\RgbColor")) {
    ...
    */
    public function getLightBackgroundLogo()
    {
        if (array_key_exists("lightBackgroundLogo", $this->_propDict)) {
            if (is_a($this->_propDict["lightBackgroundLogo"], "App\Plugins\AzureActiveDirectory\Microsoft\Model\MimeContent")) {
    ...
    */
    public function getDarkBackgroundLogo()
    {
        if (array_key_exists("darkBackgroundLogo", $this->_propDict)) {
            if (is_a($this->_propDict["darkBackgroundLogo"], "App\Plugins\AzureActiveDirectory\Microsoft\Model\MimeContent")) {
