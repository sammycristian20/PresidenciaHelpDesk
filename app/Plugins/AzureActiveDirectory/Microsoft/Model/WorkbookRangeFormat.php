    ...
    */
    public function getFill()
    {
        if (array_key_exists("fill", $this->_propDict)) {
            if (is_a($this->_propDict["fill"], "App\Plugins\AzureActiveDirectory\Microsoft\Model\WorkbookRangeFill")) {
    ...
    */
    public function getFont()
    {
        if (array_key_exists("font", $this->_propDict)) {
            if (is_a($this->_propDict["font"], "App\Plugins\AzureActiveDirectory\Microsoft\Model\WorkbookRangeFont")) {
    ...
    */
    public function getProtection()
    {
        if (array_key_exists("protection", $this->_propDict)) {
            if (is_a($this->_propDict["protection"], "App\Plugins\AzureActiveDirectory\Microsoft\Model\WorkbookFormatProtection")) {
