    ...
    */
    public function getTeamsApp()
    {
        if (array_key_exists("teamsApp", $this->_propDict)) {
            if (is_a($this->_propDict["teamsApp"], "App\Plugins\AzureActiveDirectory\Microsoft\Model\TeamsApp")) {
    ...
    */
    public function getTeamsAppDefinition()
    {
        if (array_key_exists("teamsAppDefinition", $this->_propDict)) {
            if (is_a($this->_propDict["teamsAppDefinition"], "App\Plugins\AzureActiveDirectory\Microsoft\Model\TeamsAppDefinition")) {
