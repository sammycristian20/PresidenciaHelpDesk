    ...
    */
    public function getMaintenanceWindowStartTime()
    {
        if (array_key_exists("maintenanceWindowStartTime", $this->_propDict)) {
            if (is_a($this->_propDict["maintenanceWindowStartTime"], "App\Plugins\AzureActiveDirectory\Microsoft\Model\TimeOfDay")) {
    ...
    */
    public function getMiracastChannel()
    {
        if (array_key_exists("miracastChannel", $this->_propDict)) {
            if (is_a($this->_propDict["miracastChannel"], "App\Plugins\AzureActiveDirectory\Microsoft\Model\MiracastChannel")) {
    ...
    */
    public function getWelcomeScreenMeetingInformation()
    {
        if (array_key_exists("welcomeScreenMeetingInformation", $this->_propDict)) {
            if (is_a($this->_propDict["welcomeScreenMeetingInformation"], "App\Plugins\AzureActiveDirectory\Microsoft\Model\WelcomeScreenMeetingInformation")) {
