    ...
    */
    public function getAppDataEncryptionType()
    {
        if (array_key_exists("appDataEncryptionType", $this->_propDict)) {
            if (is_a($this->_propDict["appDataEncryptionType"], "App\Plugins\AzureActiveDirectory\Microsoft\Model\ManagedAppDataEncryptionType")) {
    ...
    */
    public function getDeploymentSummary()
    {
        if (array_key_exists("deploymentSummary", $this->_propDict)) {
            if (is_a($this->_propDict["deploymentSummary"], "App\Plugins\AzureActiveDirectory\Microsoft\Model\ManagedAppPolicyDeploymentSummary")) {
