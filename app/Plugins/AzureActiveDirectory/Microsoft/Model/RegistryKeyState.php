    ...
    */
    public function getHive()
    {
        if (array_key_exists("hive", $this->_propDict)) {
            if (is_a($this->_propDict["hive"], "App\Plugins\AzureActiveDirectory\Microsoft\Model\RegistryHive")) {
    ...
    */
    public function getOperation()
    {
        if (array_key_exists("operation", $this->_propDict)) {
            if (is_a($this->_propDict["operation"], "App\Plugins\AzureActiveDirectory\Microsoft\Model\RegistryOperation")) {
    ...
    */
    public function getValueType()
    {
        if (array_key_exists("valueType", $this->_propDict)) {
            if (is_a($this->_propDict["valueType"], "App\Plugins\AzureActiveDirectory\Microsoft\Model\RegistryValueType")) {
