    ...
    */
    public function getReferences()
    {
        if (array_key_exists("references", $this->_propDict)) {
            if (is_a($this->_propDict["references"], "App\Plugins\AzureActiveDirectory\Microsoft\Model\PlannerExternalReferences")) {
    ...
    */
    public function getChecklist()
    {
        if (array_key_exists("checklist", $this->_propDict)) {
            if (is_a($this->_propDict["checklist"], "App\Plugins\AzureActiveDirectory\Microsoft\Model\PlannerChecklistItems")) {
