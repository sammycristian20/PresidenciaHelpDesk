    ...
    */
    public function getDetails()
    {
        if (array_key_exists("details", $this->_propDict)) {
            if (is_a($this->_propDict["details"], "App\Plugins\AzureActiveDirectory\Microsoft\Model\PublicErrorDetail")) {
    ...
    */
    public function getInnerError()
    {
        if (array_key_exists("innerError", $this->_propDict)) {
            if (is_a($this->_propDict["innerError"], "App\Plugins\AzureActiveDirectory\Microsoft\Model\PublicInnerError")) {
