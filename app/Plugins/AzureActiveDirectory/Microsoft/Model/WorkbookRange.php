    ...
    */
    public function getFormat()
    {
        if (array_key_exists("format", $this->_propDict)) {
            if (is_a($this->_propDict["format"], "App\Plugins\AzureActiveDirectory\Microsoft\Model\WorkbookRangeFormat")) {
    ...
    */
    public function getSort()
    {
        if (array_key_exists("sort", $this->_propDict)) {
            if (is_a($this->_propDict["sort"], "App\Plugins\AzureActiveDirectory\Microsoft\Model\WorkbookRangeSort")) {
