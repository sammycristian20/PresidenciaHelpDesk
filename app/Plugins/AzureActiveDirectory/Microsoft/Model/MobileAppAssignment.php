    ...
    */
    public function getIntent()
    {
        if (array_key_exists("intent", $this->_propDict)) {
            if (is_a($this->_propDict["intent"], "App\Plugins\AzureActiveDirectory\Microsoft\Model\InstallIntent")) {
    ...
    */
    public function getTarget()
    {
        if (array_key_exists("target", $this->_propDict)) {
            if (is_a($this->_propDict["target"], "App\Plugins\AzureActiveDirectory\Microsoft\Model\DeviceAndAppManagementAssignmentTarget")) {
    ...
    */
    public function getSettings()
    {
        if (array_key_exists("settings", $this->_propDict)) {
            if (is_a($this->_propDict["settings"], "App\Plugins\AzureActiveDirectory\Microsoft\Model\MobileAppAssignmentSettings")) {
