    ...
    */
    public function getIdentitySecurityDefaultsEnforcementPolicy()
    {
        if (array_key_exists("identitySecurityDefaultsEnforcementPolicy", $this->_propDict)) {
            if (is_a($this->_propDict["identitySecurityDefaultsEnforcementPolicy"], "App\Plugins\AzureActiveDirectory\Microsoft\Model\IdentitySecurityDefaultsEnforcementPolicy")) {
