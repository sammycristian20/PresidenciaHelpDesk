    ...
    */
    public function getPartnerState()
    {
        if (array_key_exists("partnerState", $this->_propDict)) {
            if (is_a($this->_propDict["partnerState"], "App\Plugins\AzureActiveDirectory\Microsoft\Model\DeviceManagementPartnerTenantState")) {
    ...
    */
    public function getPartnerAppType()
    {
        if (array_key_exists("partnerAppType", $this->_propDict)) {
            if (is_a($this->_propDict["partnerAppType"], "App\Plugins\AzureActiveDirectory\Microsoft\Model\DeviceManagementPartnerAppType")) {
