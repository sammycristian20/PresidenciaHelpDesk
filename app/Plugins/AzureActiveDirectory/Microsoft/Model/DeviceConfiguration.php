    ...
    */
    public function getDeviceStatusOverview()
    {
        if (array_key_exists("deviceStatusOverview", $this->_propDict)) {
            if (is_a($this->_propDict["deviceStatusOverview"], "App\Plugins\AzureActiveDirectory\Microsoft\Model\DeviceConfigurationDeviceOverview")) {
    ...
    */
    public function getUserStatusOverview()
    {
        if (array_key_exists("userStatusOverview", $this->_propDict)) {
            if (is_a($this->_propDict["userStatusOverview"], "App\Plugins\AzureActiveDirectory\Microsoft\Model\DeviceConfigurationUserOverview")) {
