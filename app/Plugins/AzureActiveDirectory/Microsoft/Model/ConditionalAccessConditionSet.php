    ...
    */
    public function getApplications()
    {
        if (array_key_exists("applications", $this->_propDict)) {
            if (is_a($this->_propDict["applications"], "App\Plugins\AzureActiveDirectory\Microsoft\Model\ConditionalAccessApplications")) {
    ...
    */
    public function getUsers()
    {
        if (array_key_exists("users", $this->_propDict)) {
            if (is_a($this->_propDict["users"], "App\Plugins\AzureActiveDirectory\Microsoft\Model\ConditionalAccessUsers")) {
    ...
    */
    public function getSignInRiskLevels()
    {
        if (array_key_exists("signInRiskLevels", $this->_propDict)) {
            if (is_a($this->_propDict["signInRiskLevels"], "App\Plugins\AzureActiveDirectory\Microsoft\Model\RiskLevel")) {
    ...
    */
    public function getPlatforms()
    {
        if (array_key_exists("platforms", $this->_propDict)) {
            if (is_a($this->_propDict["platforms"], "App\Plugins\AzureActiveDirectory\Microsoft\Model\ConditionalAccessPlatforms")) {
    ...
    */
    public function getLocations()
    {
        if (array_key_exists("locations", $this->_propDict)) {
            if (is_a($this->_propDict["locations"], "App\Plugins\AzureActiveDirectory\Microsoft\Model\ConditionalAccessLocations")) {
    ...
    */
    public function getClientAppTypes()
    {
        if (array_key_exists("clientAppTypes", $this->_propDict)) {
            if (is_a($this->_propDict["clientAppTypes"], "App\Plugins\AzureActiveDirectory\Microsoft\Model\ConditionalAccessClientApp")) {
