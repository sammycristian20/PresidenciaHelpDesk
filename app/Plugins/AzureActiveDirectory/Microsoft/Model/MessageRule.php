    ...
    */
    public function getConditions()
    {
        if (array_key_exists("conditions", $this->_propDict)) {
            if (is_a($this->_propDict["conditions"], "App\Plugins\AzureActiveDirectory\Microsoft\Model\MessageRulePredicates")) {
    ...
    */
    public function getActions()
    {
        if (array_key_exists("actions", $this->_propDict)) {
            if (is_a($this->_propDict["actions"], "App\Plugins\AzureActiveDirectory\Microsoft\Model\MessageRuleActions")) {
    ...
    */
    public function getExceptions()
    {
        if (array_key_exists("exceptions", $this->_propDict)) {
            if (is_a($this->_propDict["exceptions"], "App\Plugins\AzureActiveDirectory\Microsoft\Model\MessageRulePredicates")) {
