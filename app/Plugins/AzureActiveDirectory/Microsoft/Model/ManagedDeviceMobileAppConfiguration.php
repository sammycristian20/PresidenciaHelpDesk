    ...
    */
    public function getDeviceStatusSummary()
    {
        if (array_key_exists("deviceStatusSummary", $this->_propDict)) {
            if (is_a($this->_propDict["deviceStatusSummary"], "App\Plugins\AzureActiveDirectory\Microsoft\Model\ManagedDeviceMobileAppConfigurationDeviceSummary")) {
    ...
    */
    public function getUserStatusSummary()
    {
        if (array_key_exists("userStatusSummary", $this->_propDict)) {
            if (is_a($this->_propDict["userStatusSummary"], "App\Plugins\AzureActiveDirectory\Microsoft\Model\ManagedDeviceMobileAppConfigurationUserSummary")) {
