    ...
    */
    public function getStatus()
    {
        if (array_key_exists("status", $this->_propDict)) {
            if (is_a($this->_propDict["status"], "App\Plugins\AzureActiveDirectory\Microsoft\Model\DeviceManagementExchangeConnectorStatus")) {
    ...
    */
    public function getExchangeConnectorType()
    {
        if (array_key_exists("exchangeConnectorType", $this->_propDict)) {
            if (is_a($this->_propDict["exchangeConnectorType"], "App\Plugins\AzureActiveDirectory\Microsoft\Model\DeviceManagementExchangeConnectorType")) {
