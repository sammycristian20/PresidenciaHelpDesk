    ...
    */
    public function getLinks()
    {
        if (array_key_exists("links", $this->_propDict)) {
            if (is_a($this->_propDict["links"], "App\Plugins\AzureActiveDirectory\Microsoft\Model\RecentNotebookLinks")) {
    ...
    */
    public function getSourceService()
    {
        if (array_key_exists("sourceService", $this->_propDict)) {
            if (is_a($this->_propDict["sourceService"], "App\Plugins\AzureActiveDirectory\Microsoft\Model\OnenoteSourceService")) {
