    ...
    */
    public function getLastShared()
    {
        if (array_key_exists("lastShared", $this->_propDict)) {
            if (is_a($this->_propDict["lastShared"], "App\Plugins\AzureActiveDirectory\Microsoft\Model\SharingDetail")) {
    ...
    */
    public function getResourceVisualization()
    {
        if (array_key_exists("resourceVisualization", $this->_propDict)) {
            if (is_a($this->_propDict["resourceVisualization"], "App\Plugins\AzureActiveDirectory\Microsoft\Model\ResourceVisualization")) {
    ...
    */
    public function getResourceReference()
    {
        if (array_key_exists("resourceReference", $this->_propDict)) {
            if (is_a($this->_propDict["resourceReference"], "App\Plugins\AzureActiveDirectory\Microsoft\Model\ResourceReference")) {
    ...
    */
    public function getLastSharedMethod()
    {
        if (array_key_exists("lastSharedMethod", $this->_propDict)) {
            if (is_a($this->_propDict["lastSharedMethod"], "App\Plugins\AzureActiveDirectory\Microsoft\Model\Entity")) {
    ...
    */
    public function getResource()
    {
        if (array_key_exists("resource", $this->_propDict)) {
            if (is_a($this->_propDict["resource"], "App\Plugins\AzureActiveDirectory\Microsoft\Model\Entity")) {
