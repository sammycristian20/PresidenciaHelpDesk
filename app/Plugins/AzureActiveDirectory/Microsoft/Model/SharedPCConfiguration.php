    ...
    */
    public function getAccountManagerPolicy()
    {
        if (array_key_exists("accountManagerPolicy", $this->_propDict)) {
            if (is_a($this->_propDict["accountManagerPolicy"], "App\Plugins\AzureActiveDirectory\Microsoft\Model\SharedPCAccountManagerPolicy")) {
    ...
    */
    public function getAllowedAccounts()
    {
        if (array_key_exists("allowedAccounts", $this->_propDict)) {
            if (is_a($this->_propDict["allowedAccounts"], "App\Plugins\AzureActiveDirectory\Microsoft\Model\SharedPCAllowedAccountType")) {
    ...
    */
    public function getMaintenanceStartTime()
    {
        if (array_key_exists("maintenanceStartTime", $this->_propDict)) {
            if (is_a($this->_propDict["maintenanceStartTime"], "App\Plugins\AzureActiveDirectory\Microsoft\Model\TimeOfDay")) {
