    ...
    */
    public function getOnBehalfOf()
    {
        if (array_key_exists("onBehalfOf", $this->_propDict)) {
            if (is_a($this->_propDict["onBehalfOf"], "App\Plugins\AzureActiveDirectory\Microsoft\Model\IdentitySet")) {
    ...
    */
    public function getTransferor()
    {
        if (array_key_exists("transferor", $this->_propDict)) {
            if (is_a($this->_propDict["transferor"], "App\Plugins\AzureActiveDirectory\Microsoft\Model\IdentitySet")) {
