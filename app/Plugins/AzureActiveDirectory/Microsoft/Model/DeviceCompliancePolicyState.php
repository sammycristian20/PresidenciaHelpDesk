    ...
    */
    public function getPlatformType()
    {
        if (array_key_exists("platformType", $this->_propDict)) {
            if (is_a($this->_propDict["platformType"], "App\Plugins\AzureActiveDirectory\Microsoft\Model\PolicyPlatformType")) {
    ...
    */
    public function getState()
    {
        if (array_key_exists("state", $this->_propDict)) {
            if (is_a($this->_propDict["state"], "App\Plugins\AzureActiveDirectory\Microsoft\Model\ComplianceStatus")) {
