    ...
    */
    public function getOrganizerAvailability()
    {
        if (array_key_exists("organizerAvailability", $this->_propDict)) {
            if (is_a($this->_propDict["organizerAvailability"], "App\Plugins\AzureActiveDirectory\Microsoft\Model\FreeBusyStatus")) {
    ...
    */
    public function getAttendeeAvailability()
    {
        if (array_key_exists("attendeeAvailability", $this->_propDict)) {
            if (is_a($this->_propDict["attendeeAvailability"], "App\Plugins\AzureActiveDirectory\Microsoft\Model\AttendeeAvailability")) {
    ...
    */
    public function getLocations()
    {
        if (array_key_exists("locations", $this->_propDict)) {
            if (is_a($this->_propDict["locations"], "App\Plugins\AzureActiveDirectory\Microsoft\Model\Location")) {
    ...
    */
    public function getMeetingTimeSlot()
    {
        if (array_key_exists("meetingTimeSlot", $this->_propDict)) {
            if (is_a($this->_propDict["meetingTimeSlot"], "App\Plugins\AzureActiveDirectory\Microsoft\Model\TimeSlot")) {
