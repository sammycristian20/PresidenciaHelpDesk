    ...
    */
    public function getDeliveryOptimizationMode()
    {
        if (array_key_exists("deliveryOptimizationMode", $this->_propDict)) {
            if (is_a($this->_propDict["deliveryOptimizationMode"], "App\Plugins\AzureActiveDirectory\Microsoft\Model\WindowsDeliveryOptimizationMode")) {
    ...
    */
    public function getPrereleaseFeatures()
    {
        if (array_key_exists("prereleaseFeatures", $this->_propDict)) {
            if (is_a($this->_propDict["prereleaseFeatures"], "App\Plugins\AzureActiveDirectory\Microsoft\Model\PrereleaseFeatures")) {
    ...
    */
    public function getAutomaticUpdateMode()
    {
        if (array_key_exists("automaticUpdateMode", $this->_propDict)) {
            if (is_a($this->_propDict["automaticUpdateMode"], "App\Plugins\AzureActiveDirectory\Microsoft\Model\AutomaticUpdateMode")) {
    ...
    */
    public function getInstallationSchedule()
    {
        if (array_key_exists("installationSchedule", $this->_propDict)) {
            if (is_a($this->_propDict["installationSchedule"], "App\Plugins\AzureActiveDirectory\Microsoft\Model\WindowsUpdateInstallScheduleType")) {
    ...
    */
    public function getBusinessReadyUpdatesOnly()
    {
        if (array_key_exists("businessReadyUpdatesOnly", $this->_propDict)) {
            if (is_a($this->_propDict["businessReadyUpdatesOnly"], "App\Plugins\AzureActiveDirectory\Microsoft\Model\WindowsUpdateType")) {
