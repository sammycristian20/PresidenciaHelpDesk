    ...
    */
    public function getError()
    {
        if (array_key_exists("error", $this->_propDict)) {
            if (is_a($this->_propDict["error"], "App\Plugins\AzureActiveDirectory\Microsoft\Model\PublicError")) {
    ...
    */
    public function getSiteCollection()
    {
        if (array_key_exists("siteCollection", $this->_propDict)) {
            if (is_a($this->_propDict["siteCollection"], "App\Plugins\AzureActiveDirectory\Microsoft\Model\SiteCollection")) {
