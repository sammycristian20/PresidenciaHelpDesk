    ...
    */
    public function getStartTime()
    {
        if (array_key_exists("startTime", $this->_propDict)) {
            if (is_a($this->_propDict["startTime"], "App\Plugins\AzureActiveDirectory\Microsoft\Model\TimeOfDay")) {
    ...
    */
    public function getEndTime()
    {
        if (array_key_exists("endTime", $this->_propDict)) {
            if (is_a($this->_propDict["endTime"], "App\Plugins\AzureActiveDirectory\Microsoft\Model\TimeOfDay")) {
    ...
    */
    public function getTimeZone()
    {
        if (array_key_exists("timeZone", $this->_propDict)) {
            if (is_a($this->_propDict["timeZone"], "App\Plugins\AzureActiveDirectory\Microsoft\Model\TimeZoneBase")) {
