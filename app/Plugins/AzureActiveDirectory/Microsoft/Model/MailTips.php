    ...
    */
    public function getEmailAddress()
    {
        if (array_key_exists("emailAddress", $this->_propDict)) {
            if (is_a($this->_propDict["emailAddress"], "App\Plugins\AzureActiveDirectory\Microsoft\Model\EmailAddress")) {
    ...
    */
    public function getAutomaticReplies()
    {
        if (array_key_exists("automaticReplies", $this->_propDict)) {
            if (is_a($this->_propDict["automaticReplies"], "App\Plugins\AzureActiveDirectory\Microsoft\Model\AutomaticRepliesMailTips")) {
    ...
    */
    public function getRecipientScope()
    {
        if (array_key_exists("recipientScope", $this->_propDict)) {
            if (is_a($this->_propDict["recipientScope"], "App\Plugins\AzureActiveDirectory\Microsoft\Model\RecipientScopeType")) {
    ...
    */
    public function getRecipientSuggestions()
    {
        if (array_key_exists("recipientSuggestions", $this->_propDict)) {
            if (is_a($this->_propDict["recipientSuggestions"], "App\Plugins\AzureActiveDirectory\Microsoft\Model\Recipient")) {
    ...
    */
    public function getError()
    {
        if (array_key_exists("error", $this->_propDict)) {
            if (is_a($this->_propDict["error"], "App\Plugins\AzureActiveDirectory\Microsoft\Model\MailTipsError")) {
