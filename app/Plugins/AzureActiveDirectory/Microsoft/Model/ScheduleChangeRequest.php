    ...
    */
    public function getAssignedTo()
    {
        if (array_key_exists("assignedTo", $this->_propDict)) {
            if (is_a($this->_propDict["assignedTo"], "App\Plugins\AzureActiveDirectory\Microsoft\Model\ScheduleChangeRequestActor")) {
    ...
    */
    public function getState()
    {
        if (array_key_exists("state", $this->_propDict)) {
            if (is_a($this->_propDict["state"], "App\Plugins\AzureActiveDirectory\Microsoft\Model\ScheduleChangeState")) {
