    ...
    */
    public function getSharedWith()
    {
        if (array_key_exists("sharedWith", $this->_propDict)) {
            if (is_a($this->_propDict["sharedWith"], "App\Plugins\AzureActiveDirectory\Microsoft\Model\PlannerUserIds")) {
    ...
    */
    public function getCategoryDescriptions()
    {
        if (array_key_exists("categoryDescriptions", $this->_propDict)) {
            if (is_a($this->_propDict["categoryDescriptions"], "App\Plugins\AzureActiveDirectory\Microsoft\Model\PlannerCategoryDescriptions")) {
