    ...
    */
    public function getEnforcementLevel()
    {
        if (array_key_exists("enforcementLevel", $this->_propDict)) {
            if (is_a($this->_propDict["enforcementLevel"], "App\Plugins\AzureActiveDirectory\Microsoft\Model\WindowsInformationProtectionEnforcementLevel")) {
    ...
    */
    public function getDataRecoveryCertificate()
    {
        if (array_key_exists("dataRecoveryCertificate", $this->_propDict)) {
            if (is_a($this->_propDict["dataRecoveryCertificate"], "App\Plugins\AzureActiveDirectory\Microsoft\Model\WindowsInformationProtectionDataRecoveryCertificate")) {
