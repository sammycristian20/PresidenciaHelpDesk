    ...
    */
    public function getInfo()
    {
        if (array_key_exists("info", $this->_propDict)) {
            if (is_a($this->_propDict["info"], "App\Plugins\AzureActiveDirectory\Microsoft\Model\ParticipantInfo")) {
    ...
    */
    public function getRecordingInfo()
    {
        if (array_key_exists("recordingInfo", $this->_propDict)) {
            if (is_a($this->_propDict["recordingInfo"], "App\Plugins\AzureActiveDirectory\Microsoft\Model\RecordingInfo")) {
