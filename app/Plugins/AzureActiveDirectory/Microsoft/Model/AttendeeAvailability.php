    ...
    */
    public function getAttendee()
    {
        if (array_key_exists("attendee", $this->_propDict)) {
            if (is_a($this->_propDict["attendee"], "App\Plugins\AzureActiveDirectory\Microsoft\Model\AttendeeBase")) {
    ...
    */
    public function getAvailability()
    {
        if (array_key_exists("availability", $this->_propDict)) {
            if (is_a($this->_propDict["availability"], "App\Plugins\AzureActiveDirectory\Microsoft\Model\FreeBusyStatus")) {
