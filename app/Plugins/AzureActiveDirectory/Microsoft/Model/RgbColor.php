    ...
    */
    public function getR()
    {
        if (array_key_exists("r", $this->_propDict)) {
            if (is_a($this->_propDict["r"], "App\Plugins\AzureActiveDirectory\Microsoft\Model\Byte")) {
    ...
    */
    public function getG()
    {
        if (array_key_exists("g", $this->_propDict)) {
            if (is_a($this->_propDict["g"], "App\Plugins\AzureActiveDirectory\Microsoft\Model\Byte")) {
    ...
    */
    public function getB()
    {
        if (array_key_exists("b", $this->_propDict)) {
            if (is_a($this->_propDict["b"], "App\Plugins\AzureActiveDirectory\Microsoft\Model\Byte")) {
