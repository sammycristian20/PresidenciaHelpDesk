...
* @link      https://graph.microsoft.com
*/
class SectionLinks extends Entity
{
    ...
    */
    public function getOneNoteClientUrl()
    {
        if (array_key_exists("oneNoteClientUrl", $this->_propDict)) {
            if (is_a($this->_propDict["oneNoteClientUrl"], "App\Plugins\AzureActiveDirectory\Microsoft\Model\ExternalLink")) {
    ...
    */
    public function getOneNoteWebUrl()
    {
        if (array_key_exists("oneNoteWebUrl", $this->_propDict)) {
            if (is_a($this->_propDict["oneNoteWebUrl"], "App\Plugins\AzureActiveDirectory\Microsoft\Model\ExternalLink")) {
