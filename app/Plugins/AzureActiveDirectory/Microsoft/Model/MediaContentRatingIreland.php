    ...
    */
    public function getMovieRating()
    {
        if (array_key_exists("movieRating", $this->_propDict)) {
            if (is_a($this->_propDict["movieRating"], "App\Plugins\AzureActiveDirectory\Microsoft\Model\RatingIrelandMoviesType")) {
    ...
    */
    public function getTvRating()
    {
        if (array_key_exists("tvRating", $this->_propDict)) {
            if (is_a($this->_propDict["tvRating"], "App\Plugins\AzureActiveDirectory\Microsoft\Model\RatingIrelandTelevisionType")) {
