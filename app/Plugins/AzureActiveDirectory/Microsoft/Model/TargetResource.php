    ...
    */
    public function getGroupType()
    {
        if (array_key_exists("groupType", $this->_propDict)) {
            if (is_a($this->_propDict["groupType"], "App\Plugins\AzureActiveDirectory\Microsoft\Model\GroupType")) {
    ...
    */
    public function getModifiedProperties()
    {
        if (array_key_exists("modifiedProperties", $this->_propDict)) {
            if (is_a($this->_propDict["modifiedProperties"], "App\Plugins\AzureActiveDirectory\Microsoft\Model\ModifiedProperty")) {
