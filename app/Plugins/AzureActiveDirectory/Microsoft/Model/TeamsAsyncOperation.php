    ...
    */
    public function getOperationType()
    {
        if (array_key_exists("operationType", $this->_propDict)) {
            if (is_a($this->_propDict["operationType"], "App\Plugins\AzureActiveDirectory\Microsoft\Model\TeamsAsyncOperationType")) {
    ...
    */
    public function getStatus()
    {
        if (array_key_exists("status", $this->_propDict)) {
            if (is_a($this->_propDict["status"], "App\Plugins\AzureActiveDirectory\Microsoft\Model\TeamsAsyncOperationStatus")) {
    ...
    */
    public function getError()
    {
        if (array_key_exists("error", $this->_propDict)) {
            if (is_a($this->_propDict["error"], "App\Plugins\AzureActiveDirectory\Microsoft\Model\OperationError")) {
