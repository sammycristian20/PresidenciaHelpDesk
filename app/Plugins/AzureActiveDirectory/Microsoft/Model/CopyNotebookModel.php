    ...
    */
    public function getUserRole()
    {
        if (array_key_exists("userRole", $this->_propDict)) {
            if (is_a($this->_propDict["userRole"], "App\Plugins\AzureActiveDirectory\Microsoft\Model\OnenoteUserRole")) {
    ...
    */
    public function getLinks()
    {
        if (array_key_exists("links", $this->_propDict)) {
            if (is_a($this->_propDict["links"], "App\Plugins\AzureActiveDirectory\Microsoft\Model\NotebookLinks")) {
    ...
    */
    public function getCreatedByIdentity()
    {
        if (array_key_exists("createdByIdentity", $this->_propDict)) {
            if (is_a($this->_propDict["createdByIdentity"], "App\Plugins\AzureActiveDirectory\Microsoft\Model\IdentitySet")) {
    ...
    */
    public function getLastModifiedByIdentity()
    {
        if (array_key_exists("lastModifiedByIdentity", $this->_propDict)) {
            if (is_a($this->_propDict["lastModifiedByIdentity"], "App\Plugins\AzureActiveDirectory\Microsoft\Model\IdentitySet")) {
