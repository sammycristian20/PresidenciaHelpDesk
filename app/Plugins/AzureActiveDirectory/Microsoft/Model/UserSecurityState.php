    ...
    */
    public function getEmailRole()
    {
        if (array_key_exists("emailRole", $this->_propDict)) {
            if (is_a($this->_propDict["emailRole"], "App\Plugins\AzureActiveDirectory\Microsoft\Model\EmailRole")) {
    ...
    */
    public function getLogonType()
    {
        if (array_key_exists("logonType", $this->_propDict)) {
            if (is_a($this->_propDict["logonType"], "App\Plugins\AzureActiveDirectory\Microsoft\Model\LogonType")) {
    ...
    */
    public function getUserAccountType()
    {
        if (array_key_exists("userAccountType", $this->_propDict)) {
            if (is_a($this->_propDict["userAccountType"], "App\Plugins\AzureActiveDirectory\Microsoft\Model\UserAccountSecurityType")) {
