    ...
    */
    public function getAction()
    {
        if (array_key_exists("action", $this->_propDict)) {
            if (is_a($this->_propDict["action"], "App\Plugins\AzureActiveDirectory\Microsoft\Model\OnenotePatchActionType")) {
    ...
    */
    public function getPosition()
    {
        if (array_key_exists("position", $this->_propDict)) {
            if (is_a($this->_propDict["position"], "App\Plugins\AzureActiveDirectory\Microsoft\Model\OnenotePatchInsertPosition")) {
