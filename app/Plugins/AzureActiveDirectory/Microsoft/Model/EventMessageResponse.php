    ...
    */
    public function getProposedNewTime()
    {
        if (array_key_exists("proposedNewTime", $this->_propDict)) {
            if (is_a($this->_propDict["proposedNewTime"], "App\Plugins\AzureActiveDirectory\Microsoft\Model\TimeSlot")) {
    ...
    */
    public function getResponseType()
    {
        if (array_key_exists("responseType", $this->_propDict)) {
            if (is_a($this->_propDict["responseType"], "App\Plugins\AzureActiveDirectory\Microsoft\Model\ResponseType")) {
