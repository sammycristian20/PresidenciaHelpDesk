    ...
    */
    public function getPinUppercaseLetters()
    {
        if (array_key_exists("pinUppercaseLetters", $this->_propDict)) {
            if (is_a($this->_propDict["pinUppercaseLetters"], "App\Plugins\AzureActiveDirectory\Microsoft\Model\WindowsInformationProtectionPinCharacterRequirements")) {
    ...
    */
    public function getPinLowercaseLetters()
    {
        if (array_key_exists("pinLowercaseLetters", $this->_propDict)) {
            if (is_a($this->_propDict["pinLowercaseLetters"], "App\Plugins\AzureActiveDirectory\Microsoft\Model\WindowsInformationProtectionPinCharacterRequirements")) {
    ...
    */
    public function getPinSpecialCharacters()
    {
        if (array_key_exists("pinSpecialCharacters", $this->_propDict)) {
            if (is_a($this->_propDict["pinSpecialCharacters"], "App\Plugins\AzureActiveDirectory\Microsoft\Model\WindowsInformationProtectionPinCharacterRequirements")) {
