    ...
    */
    public function getBrowserInternetSecurityLevel()
    {
        if (array_key_exists("browserInternetSecurityLevel", $this->_propDict)) {
            if (is_a($this->_propDict["browserInternetSecurityLevel"], "App\Plugins\AzureActiveDirectory\Microsoft\Model\InternetSiteSecurityLevel")) {
    ...
    */
    public function getBrowserIntranetSecurityLevel()
    {
        if (array_key_exists("browserIntranetSecurityLevel", $this->_propDict)) {
            if (is_a($this->_propDict["browserIntranetSecurityLevel"], "App\Plugins\AzureActiveDirectory\Microsoft\Model\SiteSecurityLevel")) {
    ...
    */
    public function getBrowserTrustedSitesSecurityLevel()
    {
        if (array_key_exists("browserTrustedSitesSecurityLevel", $this->_propDict)) {
            if (is_a($this->_propDict["browserTrustedSitesSecurityLevel"], "App\Plugins\AzureActiveDirectory\Microsoft\Model\SiteSecurityLevel")) {
    ...
    */
    public function getUserAccountControlSettings()
    {
        if (array_key_exists("userAccountControlSettings", $this->_propDict)) {
            if (is_a($this->_propDict["userAccountControlSettings"], "App\Plugins\AzureActiveDirectory\Microsoft\Model\WindowsUserAccountControlSettings")) {
