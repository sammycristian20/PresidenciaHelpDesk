    ...
    */
    public function getLinks()
    {
        if (array_key_exists("links", $this->_propDict)) {
            if (is_a($this->_propDict["links"], "App\Plugins\AzureActiveDirectory\Microsoft\Model\PageLinks")) {
    ...
    */
    public function getParentSection()
    {
        if (array_key_exists("parentSection", $this->_propDict)) {
            if (is_a($this->_propDict["parentSection"], "App\Plugins\AzureActiveDirectory\Microsoft\Model\OnenoteSection")) {
