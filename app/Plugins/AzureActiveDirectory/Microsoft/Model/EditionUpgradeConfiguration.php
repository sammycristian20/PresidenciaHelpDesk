    ...
    */
    public function getLicenseType()
    {
        if (array_key_exists("licenseType", $this->_propDict)) {
            if (is_a($this->_propDict["licenseType"], "App\Plugins\AzureActiveDirectory\Microsoft\Model\EditionUpgradeLicenseType")) {
    ...
    */
    public function getTargetEdition()
    {
        if (array_key_exists("targetEdition", $this->_propDict)) {
            if (is_a($this->_propDict["targetEdition"], "App\Plugins\AzureActiveDirectory\Microsoft\Model\Windows10EditionType")) {
