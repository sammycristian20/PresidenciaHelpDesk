    ...
    */
    public function getDeviceOperatingSystemSummary()
    {
        if (array_key_exists("deviceOperatingSystemSummary", $this->_propDict)) {
            if (is_a($this->_propDict["deviceOperatingSystemSummary"], "App\Plugins\AzureActiveDirectory\Microsoft\Model\DeviceOperatingSystemSummary")) {
    ...
    */
    public function getDeviceExchangeAccessStateSummary()
    {
        if (array_key_exists("deviceExchangeAccessStateSummary", $this->_propDict)) {
            if (is_a($this->_propDict["deviceExchangeAccessStateSummary"], "App\Plugins\AzureActiveDirectory\Microsoft\Model\DeviceExchangeAccessStateSummary")) {
