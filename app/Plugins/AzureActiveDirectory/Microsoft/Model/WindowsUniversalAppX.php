    ...
    */
    public function getApplicableArchitectures()
    {
        if (array_key_exists("applicableArchitectures", $this->_propDict)) {
            if (is_a($this->_propDict["applicableArchitectures"], "App\Plugins\AzureActiveDirectory\Microsoft\Model\WindowsArchitecture")) {
    ...
    */
    public function getApplicableDeviceTypes()
    {
        if (array_key_exists("applicableDeviceTypes", $this->_propDict)) {
            if (is_a($this->_propDict["applicableDeviceTypes"], "App\Plugins\AzureActiveDirectory\Microsoft\Model\WindowsDeviceType")) {
    ...
    */
    public function getMinimumSupportedOperatingSystem()
    {
        if (array_key_exists("minimumSupportedOperatingSystem", $this->_propDict)) {
            if (is_a($this->_propDict["minimumSupportedOperatingSystem"], "App\Plugins\AzureActiveDirectory\Microsoft\Model\WindowsMinimumOperatingSystem")) {
