    ...
    */
    public function getIdentity()
    {
        if (array_key_exists("identity", $this->_propDict)) {
            if (is_a($this->_propDict["identity"], "App\Plugins\AzureActiveDirectory\Microsoft\Model\IdentitySet")) {
    ...
    */
    public function getEndpointType()
    {
        if (array_key_exists("endpointType", $this->_propDict)) {
            if (is_a($this->_propDict["endpointType"], "App\Plugins\AzureActiveDirectory\Microsoft\Model\EndpointType")) {
