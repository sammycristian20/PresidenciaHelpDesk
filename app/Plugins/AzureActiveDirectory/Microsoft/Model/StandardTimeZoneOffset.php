    ...
    */
    public function getTime()
    {
        if (array_key_exists("time", $this->_propDict)) {
            if (is_a($this->_propDict["time"], "App\Plugins\AzureActiveDirectory\Microsoft\Model\TimeOfDay")) {
    ...
    */
    public function getDayOfWeek()
    {
        if (array_key_exists("dayOfWeek", $this->_propDict)) {
            if (is_a($this->_propDict["dayOfWeek"], "App\Plugins\AzureActiveDirectory\Microsoft\Model\DayOfWeek")) {
