    ...
    */
    public function getImportance()
    {
        if (array_key_exists("importance", $this->_propDict)) {
            if (is_a($this->_propDict["importance"], "App\Plugins\AzureActiveDirectory\Microsoft\Model\CalendarSharingActionImportance")) {
    ...
    */
    public function getActionType()
    {
        if (array_key_exists("actionType", $this->_propDict)) {
            if (is_a($this->_propDict["actionType"], "App\Plugins\AzureActiveDirectory\Microsoft\Model\CalendarSharingActionType")) {
    ...
    */
    public function getAction()
    {
        if (array_key_exists("action", $this->_propDict)) {
            if (is_a($this->_propDict["action"], "App\Plugins\AzureActiveDirectory\Microsoft\Model\CalendarSharingAction")) {
