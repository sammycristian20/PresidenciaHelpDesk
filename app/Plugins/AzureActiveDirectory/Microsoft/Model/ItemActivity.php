    ...
    */
    public function getAccess()
    {
        if (array_key_exists("access", $this->_propDict)) {
            if (is_a($this->_propDict["access"], "App\Plugins\AzureActiveDirectory\Microsoft\Model\AccessAction")) {
    ...
    */
    public function getActor()
    {
        if (array_key_exists("actor", $this->_propDict)) {
            if (is_a($this->_propDict["actor"], "App\Plugins\AzureActiveDirectory\Microsoft\Model\IdentitySet")) {
