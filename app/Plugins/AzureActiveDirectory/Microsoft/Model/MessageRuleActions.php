    ...
    */
    public function getMarkImportance()
    {
        if (array_key_exists("markImportance", $this->_propDict)) {
            if (is_a($this->_propDict["markImportance"], "App\Plugins\AzureActiveDirectory\Microsoft\Model\Importance")) {
    ...
    */
    public function getForwardTo()
    {
        if (array_key_exists("forwardTo", $this->_propDict)) {
            if (is_a($this->_propDict["forwardTo"], "App\Plugins\AzureActiveDirectory\Microsoft\Model\Recipient")) {
    ...
    */
    public function getForwardAsAttachmentTo()
    {
        if (array_key_exists("forwardAsAttachmentTo", $this->_propDict)) {
            if (is_a($this->_propDict["forwardAsAttachmentTo"], "App\Plugins\AzureActiveDirectory\Microsoft\Model\Recipient")) {
    ...
    */
    public function getRedirectTo()
    {
        if (array_key_exists("redirectTo", $this->_propDict)) {
            if (is_a($this->_propDict["redirectTo"], "App\Plugins\AzureActiveDirectory\Microsoft\Model\Recipient")) {
