    ...
    */
    public function getPrivacyProfile()
    {
        if (array_key_exists("privacyProfile", $this->_propDict)) {
            if (is_a($this->_propDict["privacyProfile"], "App\Plugins\AzureActiveDirectory\Microsoft\Model\PrivacyProfile")) {
    ...
    */
    public function getMobileDeviceManagementAuthority()
    {
        if (array_key_exists("mobileDeviceManagementAuthority", $this->_propDict)) {
            if (is_a($this->_propDict["mobileDeviceManagementAuthority"], "App\Plugins\AzureActiveDirectory\Microsoft\Model\MdmAuthority")) {
