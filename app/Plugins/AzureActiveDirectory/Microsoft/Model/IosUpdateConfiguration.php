    ...
    */
    public function getActiveHoursStart()
    {
        if (array_key_exists("activeHoursStart", $this->_propDict)) {
            if (is_a($this->_propDict["activeHoursStart"], "App\Plugins\AzureActiveDirectory\Microsoft\Model\TimeOfDay")) {
    ...
    */
    public function getActiveHoursEnd()
    {
        if (array_key_exists("activeHoursEnd", $this->_propDict)) {
            if (is_a($this->_propDict["activeHoursEnd"], "App\Plugins\AzureActiveDirectory\Microsoft\Model\TimeOfDay")) {
