    ...
    */
    public function getApplication()
    {
        if (array_key_exists("application", $this->_propDict)) {
            if (is_a($this->_propDict["application"], "App\Plugins\AzureActiveDirectory\Microsoft\Model\WorkbookApplication")) {
    ...
    */
    public function getFunctions()
    {
        if (array_key_exists("functions", $this->_propDict)) {
            if (is_a($this->_propDict["functions"], "App\Plugins\AzureActiveDirectory\Microsoft\Model\WorkbookFunctions")) {
