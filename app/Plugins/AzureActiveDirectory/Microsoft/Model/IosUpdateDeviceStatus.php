    ...
    */
    public function getInstallStatus()
    {
        if (array_key_exists("installStatus", $this->_propDict)) {
            if (is_a($this->_propDict["installStatus"], "App\Plugins\AzureActiveDirectory\Microsoft\Model\IosUpdatesInstallStatus")) {
    ...
    */
    public function getStatus()
    {
        if (array_key_exists("status", $this->_propDict)) {
            if (is_a($this->_propDict["status"], "App\Plugins\AzureActiveDirectory\Microsoft\Model\ComplianceStatus")) {
