    ...
    */
    public function getScheduledInstallDay()
    {
        if (array_key_exists("scheduledInstallDay", $this->_propDict)) {
            if (is_a($this->_propDict["scheduledInstallDay"], "App\Plugins\AzureActiveDirectory\Microsoft\Model\WeeklySchedule")) {
    ...
    */
    public function getScheduledInstallTime()
    {
        if (array_key_exists("scheduledInstallTime", $this->_propDict)) {
            if (is_a($this->_propDict["scheduledInstallTime"], "App\Plugins\AzureActiveDirectory\Microsoft\Model\TimeOfDay")) {
