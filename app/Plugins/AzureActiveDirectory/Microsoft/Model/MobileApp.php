    ...
    */
    public function getLargeIcon()
    {
        if (array_key_exists("largeIcon", $this->_propDict)) {
            if (is_a($this->_propDict["largeIcon"], "App\Plugins\AzureActiveDirectory\Microsoft\Model\MimeContent")) {
    ...
    */
    public function getPublishingState()
    {
        if (array_key_exists("publishingState", $this->_propDict)) {
            if (is_a($this->_propDict["publishingState"], "App\Plugins\AzureActiveDirectory\Microsoft\Model\MobileAppPublishingState")) {
