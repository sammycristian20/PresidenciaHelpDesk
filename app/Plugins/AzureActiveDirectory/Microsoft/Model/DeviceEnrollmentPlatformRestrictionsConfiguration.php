    ...
    */
    public function getIosRestriction()
    {
        if (array_key_exists("iosRestriction", $this->_propDict)) {
            if (is_a($this->_propDict["iosRestriction"], "App\Plugins\AzureActiveDirectory\Microsoft\Model\DeviceEnrollmentPlatformRestriction")) {
    ...
    */
    public function getWindowsRestriction()
    {
        if (array_key_exists("windowsRestriction", $this->_propDict)) {
            if (is_a($this->_propDict["windowsRestriction"], "App\Plugins\AzureActiveDirectory\Microsoft\Model\DeviceEnrollmentPlatformRestriction")) {
    ...
    */
    public function getWindowsMobileRestriction()
    {
        if (array_key_exists("windowsMobileRestriction", $this->_propDict)) {
            if (is_a($this->_propDict["windowsMobileRestriction"], "App\Plugins\AzureActiveDirectory\Microsoft\Model\DeviceEnrollmentPlatformRestriction")) {
    ...
    */
    public function getAndroidRestriction()
    {
        if (array_key_exists("androidRestriction", $this->_propDict)) {
            if (is_a($this->_propDict["androidRestriction"], "App\Plugins\AzureActiveDirectory\Microsoft\Model\DeviceEnrollmentPlatformRestriction")) {
    ...
    */
    public function getMacOSRestriction()
    {
        if (array_key_exists("macOSRestriction", $this->_propDict)) {
            if (is_a($this->_propDict["macOSRestriction"], "App\Plugins\AzureActiveDirectory\Microsoft\Model\DeviceEnrollmentPlatformRestriction")) {
