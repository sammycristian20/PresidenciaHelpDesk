    ...
    */
    public function getSharedTimeOff()
    {
        if (array_key_exists("sharedTimeOff", $this->_propDict)) {
            if (is_a($this->_propDict["sharedTimeOff"], "App\Plugins\AzureActiveDirectory\Microsoft\Model\TimeOffItem")) {
    ...
    */
    public function getDraftTimeOff()
    {
        if (array_key_exists("draftTimeOff", $this->_propDict)) {
            if (is_a($this->_propDict["draftTimeOff"], "App\Plugins\AzureActiveDirectory\Microsoft\Model\TimeOffItem")) {
