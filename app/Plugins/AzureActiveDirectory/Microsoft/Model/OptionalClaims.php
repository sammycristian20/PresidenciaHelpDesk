    ...
    */
    public function getIdToken()
    {
        if (array_key_exists("idToken", $this->_propDict)) {
            if (is_a($this->_propDict["idToken"], "App\Plugins\AzureActiveDirectory\Microsoft\Model\OptionalClaim")) {
    ...
    */
    public function getAccessToken()
    {
        if (array_key_exists("accessToken", $this->_propDict)) {
            if (is_a($this->_propDict["accessToken"], "App\Plugins\AzureActiveDirectory\Microsoft\Model\OptionalClaim")) {
    ...
    */
    public function getSaml2Token()
    {
        if (array_key_exists("saml2Token", $this->_propDict)) {
            if (is_a($this->_propDict["saml2Token"], "App\Plugins\AzureActiveDirectory\Microsoft\Model\OptionalClaim")) {
