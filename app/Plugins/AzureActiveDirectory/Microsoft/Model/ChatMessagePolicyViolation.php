    ...
    */
    public function getDlpAction()
    {
        if (array_key_exists("dlpAction", $this->_propDict)) {
            if (is_a($this->_propDict["dlpAction"], "App\Plugins\AzureActiveDirectory\Microsoft\Model\ChatMessagePolicyViolationDlpActionTypes")) {
    ...
    */
    public function getPolicyTip()
    {
        if (array_key_exists("policyTip", $this->_propDict)) {
            if (is_a($this->_propDict["policyTip"], "App\Plugins\AzureActiveDirectory\Microsoft\Model\ChatMessagePolicyViolationPolicyTip")) {
    ...
    */
    public function getUserAction()
    {
        if (array_key_exists("userAction", $this->_propDict)) {
            if (is_a($this->_propDict["userAction"], "App\Plugins\AzureActiveDirectory\Microsoft\Model\ChatMessagePolicyViolationUserActionTypes")) {
    ...
    */
    public function getVerdictDetails()
    {
        if (array_key_exists("verdictDetails", $this->_propDict)) {
            if (is_a($this->_propDict["verdictDetails"], "App\Plugins\AzureActiveDirectory\Microsoft\Model\ChatMessagePolicyViolationVerdictDetailsTypes")) {
