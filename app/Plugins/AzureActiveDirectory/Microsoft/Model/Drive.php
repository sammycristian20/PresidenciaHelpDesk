    ...
    */
    public function getQuota()
    {
        if (array_key_exists("quota", $this->_propDict)) {
            if (is_a($this->_propDict["quota"], "App\Plugins\AzureActiveDirectory\Microsoft\Model\Quota")) {
    ...
    */
    public function getSystem()
    {
        if (array_key_exists("system", $this->_propDict)) {
            if (is_a($this->_propDict["system"], "App\Plugins\AzureActiveDirectory\Microsoft\Model\SystemFacet")) {
