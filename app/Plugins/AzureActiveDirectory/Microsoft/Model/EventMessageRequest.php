    ...
    */
    public function getPreviousLocation()
    {
        if (array_key_exists("previousLocation", $this->_propDict)) {
            if (is_a($this->_propDict["previousLocation"], "App\Plugins\AzureActiveDirectory\Microsoft\Model\Location")) {
    ...
    */
    public function getPreviousStartDateTime()
    {
        if (array_key_exists("previousStartDateTime", $this->_propDict)) {
            if (is_a($this->_propDict["previousStartDateTime"], "App\Plugins\AzureActiveDirectory\Microsoft\Model\DateTimeTimeZone")) {
    ...
    */
    public function getPreviousEndDateTime()
    {
        if (array_key_exists("previousEndDateTime", $this->_propDict)) {
            if (is_a($this->_propDict["previousEndDateTime"], "App\Plugins\AzureActiveDirectory\Microsoft\Model\DateTimeTimeZone")) {
    ...
    */
    public function getMeetingRequestType()
    {
        if (array_key_exists("meetingRequestType", $this->_propDict)) {
            if (is_a($this->_propDict["meetingRequestType"], "App\Plugins\AzureActiveDirectory\Microsoft\Model\MeetingRequestType")) {
