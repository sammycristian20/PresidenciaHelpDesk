    ...
    */
    public function getSharedBy()
    {
        if (array_key_exists("sharedBy", $this->_propDict)) {
            if (is_a($this->_propDict["sharedBy"], "App\Plugins\AzureActiveDirectory\Microsoft\Model\InsightIdentity")) {
    ...
    */
    public function getSharingReference()
    {
        if (array_key_exists("sharingReference", $this->_propDict)) {
            if (is_a($this->_propDict["sharingReference"], "App\Plugins\AzureActiveDirectory\Microsoft\Model\ResourceReference")) {
