    ...
    */
    public function getFill()
    {
        if (array_key_exists("fill", $this->_propDict)) {
            if (is_a($this->_propDict["fill"], "App\Plugins\AzureActiveDirectory\Microsoft\Model\WorkbookChartFill")) {
    ...
    */
    public function getLine()
    {
        if (array_key_exists("line", $this->_propDict)) {
            if (is_a($this->_propDict["line"], "App\Plugins\AzureActiveDirectory\Microsoft\Model\WorkbookChartLineFormat")) {
