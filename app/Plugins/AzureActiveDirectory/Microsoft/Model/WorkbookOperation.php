    ...
    */
    public function getStatus()
    {
        if (array_key_exists("status", $this->_propDict)) {
            if (is_a($this->_propDict["status"], "App\Plugins\AzureActiveDirectory\Microsoft\Model\WorkbookOperationStatus")) {
    ...
    */
    public function getError()
    {
        if (array_key_exists("error", $this->_propDict)) {
            if (is_a($this->_propDict["error"], "App\Plugins\AzureActiveDirectory\Microsoft\Model\WorkbookOperationError")) {
