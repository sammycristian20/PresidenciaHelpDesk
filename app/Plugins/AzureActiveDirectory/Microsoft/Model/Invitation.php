    ...
    */
    public function getInvitedUserMessageInfo()
    {
        if (array_key_exists("invitedUserMessageInfo", $this->_propDict)) {
            if (is_a($this->_propDict["invitedUserMessageInfo"], "App\Plugins\AzureActiveDirectory\Microsoft\Model\InvitedUserMessageInfo")) {
    ...
    */
    public function getInvitedUser()
    {
        if (array_key_exists("invitedUser", $this->_propDict)) {
            if (is_a($this->_propDict["invitedUser"], "App\Plugins\AzureActiveDirectory\Microsoft\Model\User")) {
