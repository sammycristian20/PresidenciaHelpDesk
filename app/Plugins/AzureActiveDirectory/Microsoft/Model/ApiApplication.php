    ...
    */
    public function getPreAuthorizedApplications()
    {
        if (array_key_exists("preAuthorizedApplications", $this->_propDict)) {
            if (is_a($this->_propDict["preAuthorizedApplications"], "App\Plugins\AzureActiveDirectory\Microsoft\Model\PreAuthorizedApplication")) {
    ...
    */
    public function getOauth2PermissionScopes()
    {
        if (array_key_exists("oauth2PermissionScopes", $this->_propDict)) {
            if (is_a($this->_propDict["oauth2PermissionScopes"], "App\Plugins\AzureActiveDirectory\Microsoft\Model\PermissionScope")) {
