    ...
    */
    public function getCompletedDateTime()
    {
        if (array_key_exists("completedDateTime", $this->_propDict)) {
            if (is_a($this->_propDict["completedDateTime"], "App\Plugins\AzureActiveDirectory\Microsoft\Model\DateTimeTimeZone")) {
    ...
    */
    public function getDueDateTime()
    {
        if (array_key_exists("dueDateTime", $this->_propDict)) {
            if (is_a($this->_propDict["dueDateTime"], "App\Plugins\AzureActiveDirectory\Microsoft\Model\DateTimeTimeZone")) {
    ...
    */
    public function getFlagStatus()
    {
        if (array_key_exists("flagStatus", $this->_propDict)) {
            if (is_a($this->_propDict["flagStatus"], "App\Plugins\AzureActiveDirectory\Microsoft\Model\FollowupFlagStatus")) {
