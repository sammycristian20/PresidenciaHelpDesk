    ...
    */
    public function getPattern()
    {
        if (array_key_exists("pattern", $this->_propDict)) {
            if (is_a($this->_propDict["pattern"], "App\Plugins\AzureActiveDirectory\Microsoft\Model\RecurrencePattern")) {
    ...
    */
    public function getRange()
    {
        if (array_key_exists("range", $this->_propDict)) {
            if (is_a($this->_propDict["range"], "App\Plugins\AzureActiveDirectory\Microsoft\Model\RecurrenceRange")) {
