    ...
    */
    public function getOrganizer()
    {
        if (array_key_exists("organizer", $this->_propDict)) {
            if (is_a($this->_propDict["organizer"], "App\Plugins\AzureActiveDirectory\Microsoft\Model\MeetingParticipantInfo")) {
    ...
    */
    public function getAttendees()
    {
        if (array_key_exists("attendees", $this->_propDict)) {
            if (is_a($this->_propDict["attendees"], "App\Plugins\AzureActiveDirectory\Microsoft\Model\MeetingParticipantInfo")) {
