    ...
    */
    public function getPasswordRequiredType()
    {
        if (array_key_exists("passwordRequiredType", $this->_propDict)) {
            if (is_a($this->_propDict["passwordRequiredType"], "App\Plugins\AzureActiveDirectory\Microsoft\Model\AndroidRequiredPasswordType")) {
    ...
    */
    public function getWebBrowserCookieSettings()
    {
        if (array_key_exists("webBrowserCookieSettings", $this->_propDict)) {
            if (is_a($this->_propDict["webBrowserCookieSettings"], "App\Plugins\AzureActiveDirectory\Microsoft\Model\WebBrowserCookieSettings")) {
