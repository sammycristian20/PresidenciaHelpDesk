    ...
    */
    public function getChangeType()
    {
        if (array_key_exists("changeType", $this->_propDict)) {
            if (is_a($this->_propDict["changeType"], "App\Plugins\AzureActiveDirectory\Microsoft\Model\ChangeType")) {
    ...
    */
    public function getResourceData()
    {
        if (array_key_exists("resourceData", $this->_propDict)) {
            if (is_a($this->_propDict["resourceData"], "App\Plugins\AzureActiveDirectory\Microsoft\Model\ResourceData")) {
