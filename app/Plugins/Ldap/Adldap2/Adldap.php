...
use App\Plugins\Ldap\Adldap2\Connections\Provider;
...
class Adldap implements AdldapInterface
{
    ...
    public function addProvider($config, $name = 'default', ConnectionInterface $connection = null)
    {
        ...
        throw new InvalidArgumentException(
            "You must provide a configuration array or an instance of App\Plugins\Ldap\Adldap2\Connections\ProviderInterface."
        );
    }
