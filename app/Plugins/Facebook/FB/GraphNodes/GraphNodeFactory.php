 ...
 *
 */
namespace App\Plugins\Facebook\FB\GraphNodes;

use App\Plugins\Facebook\FB\FacebookResponse;
...
class GraphNodeFactory
{
     ...
     */
    const BASE_GRAPH_NODE_CLASS = 'App\Plugins\Facebook\FB\GraphNodes\GraphNode';

    /**
     * @const string The base graph edge class.
     */
    const BASE_GRAPH_EDGE_CLASS = 'App\Plugins\Facebook\FB\GraphNodes\GraphEdge';

    /**
     * @const string The graph object prefix.
     */
    const BASE_GRAPH_OBJECT_PREFIX = 'App\Plugins\Facebook\FB\GraphNodes\\';
