...
class GroupController extends Controller
{
     ...
     */
    public function index(Permission $group, Department $department, Group_assign_department $group_assign_department)
    {
        try {
            $groups = $group->get();
     ...
     * @return type Response
     */
    public function store(Permission $group, GroupRequest $request)
    {
        try {
            /* Check Whether function success or not */
            $group->fill($request->input())->save();

            return redirect('groups')->with('success', Lang::get('lang.group_saved_successfully'));
        } catch (Exception $e) {
     ...
     *
     * @param type int    $id
     * @param type Permission $group
     *
     * @return type Response
     */
    public function edit($id, Permission $group)
    {
        try {
     ...
     * @return type Response
     */
    public function update($id, Permission $group, GroupUpdateRequest $request)
    {
        ...
        //upload organization docs
        $upload_docs = $request->input('can_upload_document');
        $var->can_upload_document = $upload_docs;
     ...
     * @return type Response
     */
    public function destroy($id, Permission $group, Group_assign_department $group_assign_department)
    {
