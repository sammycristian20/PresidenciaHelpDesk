    ...
    public function checkPHPExecutablePath(Request $request)
    {
        try{
            ...
            if($this->execEnabled()) {
                ...
                return (version_compare($version, '7.3', '>=') == 1) ? successResponse(trans('lang.valid-php-path')): errorResponse(trans('lang.invalid-php-version-or-path'));
            }
            
            return errorResponse(trans('lang.please_enable_php_exec_for_cronjob_check'));
        } catch(\Exception $e){
