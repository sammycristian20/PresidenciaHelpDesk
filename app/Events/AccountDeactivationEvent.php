...
/**
 * Event gets dispatched during deactivating the user accounts so different
 ...
 */
class AccountDeactivationEvent
{
    use Dispatchable, InteractsWithSockets, SerializesModels;

    /**
     * @var User account for deactivation
     */
    public $user;

    /**
     * @var string account deactivation event type: requesting/processing
     */
    public $event;
