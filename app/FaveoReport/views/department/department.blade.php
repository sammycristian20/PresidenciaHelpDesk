...
<!-- header -->
@section('PageHeader')
<h1>{!! Lang::get('lang.department') !!} {!! Lang::get('lang.report') !!}</h1>
@stop
<!-- /header -->
<!-- breadcrumbs -->
@section('breadcrumbs')
...
<div class="box box-primary">
    <div class="box-header">
        ...
        <div class="btn-group">
            {!! Form::select('team',$departments,null,['class'=>'form-control','id'=>'department']) !!}
        </div>
                ...
                <ul class="list-unstyled">
                    <li>
                        ...
                        <div>
                            ...
                            <canvas id="department-source"></canvas>
                        </div>
                    ...
                    <li>
                        ...
                        <div>
                            ...
                            <canvas id="department-priority"></canvas>
                        </div>
                    ...
                    <li>
                        ...
                        <div>
                            ...
                            <canvas id="department-sla"></canvas>
                        </div>
...
@include('report::asset.department-datatable')
<script src="{{assetLink('js','chart')}}"></script>
@include('report::asset.department-js')
