...
namespace App\HelptopicType\Controllers;
        ...
        return ' <div class="col-md-2 col-sm-6">
                    <div class="settingiconblue">
                        <div class="settingdivblue">
                            <a href="' . url('helpdesk/helptopic-type/settings/status') . '">
                                <span class="fa-stack fa-2x">
                                    <i class="fa fa-link"></i>
                                </span>
                            </a>
                        </div>
                        <p class="box-title" >'.Lang::get('HelptopicType::lang.helptopic_type_linking').'</p>
                    </div>
                </div>';
    }
