...
export default {
  ...
  computed: {
    getSrc: function() {
      return this.sourceUrl ? this.sourceUrl : this.basePath() + '/themes/default/common/images/' + this.defaultImage;
    }
  },
  ...
  methods: {
    ...
    **/
    onImageLoadError(event) {
      ...
      event.target.src = this.basePath() + '/themes/default/common/images/' + this.defaultImage;
    }
  }
