<template>
	...
	<div class="btn-group">
		...
		<a id="status">
			<span title="Status" :class="{'btn btn-success btn-xs':data.status !== 0,'btn btn-danger btn-xs':data.status === 0}" id="edit_btn">{{data.status ? lang('active') : lang('inactive')}}</span>
		</a>
...
<script type="text/javascript">
	...
	export default {
		...
		name:"data-table-status",

		description: "Contains active and inactive status",		
